...
export class ProductList extends React.Component {
    ...
    render() {
        ...
        return <div>
            ...
            <p>
                <a href="addProduct"><button style={{ backgroundColor:"blue" }}>Create New</button></a>
            </p>
            {contents}
        </div>;
    }
            ...
            <tbody>
                {productListData.map(item =>
                    <tr key={item.productId}>
                        ...
                        <td ><button className="action" style={{ backgroundColor: "yellow" }}onClick={(id) => this.FuncEdit(item.productId)}>Edit</button></td>
                        <td ><button className="action" style={{ backgroundColor: "red" }} onClick={(id) => this.FuncDelete(item.productId)}>Delete</button></td>
                    </tr>
                )}
            </tbody>
        </table>;
