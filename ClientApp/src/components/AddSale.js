            ...
            <form onSubmit={this.FuncSave} >
                ...
                < div className="form-group row" >
                    ...
                    <div className="col-md-4">
                        <input className="form-control" type="text" name="dateSold" defaultValue={this.state.salesList.dateSold} required />
                    </div>
                </div >
                ...
                <div className="form-group row">
                    ...
                    <div className="col-md-4">
                        <input className="form-control" type="text" name="CustomerId" defaultValue={this.state.salesList.customerId} required />
                    </div>
                </div>
                ...
                <div className="form-group row">
                    ...
                    <div className="col-md-4">
                        <input className="form-control" type="text" name="ProductId" defaultValue={this.state.salesList.ProductId} required />
                    </div>
                </div>
                <div className="form-group row">
                    <label className="control-label col-md-12" htmlFor="storeid" >Store</label>
                    <div className="col-md-4">
                        <input className="form-control" type="text" name="Storeid" defaultValue={this.state.salesList.StoreId} required />
                    </div>
                </div>
