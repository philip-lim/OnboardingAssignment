        ...
        return (
                ...
                < div className="form-group row" >
                    ...
                    <div className="col-md-4">
                        <input className="form-control" type="text" name="productName" defaultValue={this.state.productList.productName} required />
                    </div>
                </div >
                ...
                <div className="form-group row">
                    ...
                    <div className="col-md-4">
                        <input className="form-control" type="text" name="productPrice" defaultValue={this.state.productList.productPrice} required />
                    </div>
                </div>
